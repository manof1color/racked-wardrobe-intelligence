...
| --- | --- | --- |
| Which Hanger turn is requested, and which pieces it uses | `lib/hanger-turn.ts`, `lib/outfit-ranking.ts` | `POST /api/agents/consumer` |
...
| Code, docs & GitHub | 15% | Typed modules, **564 passing tests**, CI running audit + lint + typecheck + tests + build, CodeQL, and incremental reviewed PRs ([PROGRESS.md](PROGRESS.md)) |
