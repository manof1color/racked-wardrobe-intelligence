...
- [x] The verification boundary is unchanged and regression-tested at the new entry point: a brand name alone verifies nothing, a match requires a GTIN or brand-plus-SKU registry evidence, and the label-check route writes nothing and cannot reach image-hash matching.
...
- [x] 426 automated tests and lint pass (re-verified 2026-09-18); the clean CI gate runs type check, tests, production build, production dependency audit, and CodeQL before merge.
