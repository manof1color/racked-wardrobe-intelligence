...
- [x] 581 automated tests and lint pass (re-verified 2026-09-24); the clean CI gate runs type check, tests, production build, production dependency audit, and CodeQL before merge.
