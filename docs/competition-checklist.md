...
- [x] 297 automated tests and lint pass locally (re-verified 2026-09-03); the clean CI gate runs type check, tests, production build, production dependency audit, and CodeQL before merge.
