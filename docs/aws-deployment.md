...
- [x] Local lint passed.
- [x] All 206 automated tests pass locally (re-verified 2026-08-22); CI and CodeQL remain mandatory on every PR.
- [x] PR #80 merged as `6fa50c8` after Validate Racked and CodeQL passed; Amplify's replacement is visible at the production URL (published 2026-08-22 06:00 UTC). Landing and Consumer routes return HTTP 200 and the signed-out Consumer route preserves the access-control boundary.
