...
- [x] Local lint passed.
- [x] All 289 automated tests pass locally (re-verified 2026-09-01); clean CI type-check, build, production dependency audit, and CodeQL remain mandatory before merge.
